...
# 讀取資料
X_train = pd.read_csv('X_train.csv', header=0, usecols=lambda x: x != 0).values
y_train = pd.read_csv('y_train.csv', header=0, usecols=[1]).values
X_test = pd.read_csv('X_test.csv', header=0, usecols=lambda x: x != 0).values
